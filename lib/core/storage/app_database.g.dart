...
class $DepartmentsTable extends Departments
    with TableInfo<$DepartmentsTable, DepartmentEntity> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<DepartmentEntity> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  DepartmentEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class DepartmentEntity extends DataClass
    implements Insertable<DepartmentEntity> {
  final int id;
  final String name;
  final int? siteId;
  final bool active;
  ...
  factory DepartmentEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  @override
  String toString() {
    return (StringBuffer('DepartmentEntity(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('siteId: $siteId, ')
          ..write('active: $active, ')
...
class $TaskTemplatesTable extends TaskTemplates
  ...
  static const VerificationMeta _requiresSupplierSelectionMeta =
      const VerificationMeta('requiresSupplierSelection');
  @override
  late final GeneratedColumn<bool> requiresSupplierSelection =
      GeneratedColumn<bool>(
        'requires_supplier_selection',
        aliasedName,
        false,
        type: DriftSqlType.bool,
        requiredDuringInsert: false,
        defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("requires_supplier_selection" IN (0, 1))',
        ),
        defaultValue: const Constant(false),
      );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('requires_supplier_selection')) {
      context.handle(
        _requiresSupplierSelectionMeta,
        requiresSupplierSelection.isAcceptableOrUnknown(
          data['requires_supplier_selection']!,
          _requiresSupplierSelectionMeta,
        ),
      );
    }
  ...
  TaskTemplateEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TaskTemplateEntity(
      ...
      requiresSupplierSelection: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
...
class TaskTemplatesCompanion extends UpdateCompanion<TaskTemplateEntity> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (requiresSupplierSelection.present) {
      map['requires_supplier_selection'] = Variable<bool>(
...
final class $$SitesTableReferences
  ...
  static MultiTypedResultKey<$DepartmentsTable, List<DepartmentEntity>>
  _departmentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.departments,
    aliasName: 'sites__id__departments__site_id',
  );
...
final class $$DepartmentsTableReferences
  ...
  static $SitesTable _siteIdTable(_$AppDatabase db) =>
      db.sites.createAlias('departments__site_id__sites__id');
...
class $$DepartmentsTableTableManager
    extends
        RootTableManager<
          ...
          DepartmentEntity,
          PrefetchHooks Function({bool siteId, bool usersRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({siteId = false, usersRefs = false}) {
            return PrefetchHooks(
              db: db,
...
final class $$SuppliersTableReferences
  ...
  _taskSubmissionsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.taskSubmissions,
    aliasName: 'suppliers__id__task_submissions__supplier_id',
  );
...
final class $$TaskSubmissionsTableReferences
  ...
  static $SuppliersTable _supplierIdTable(_$AppDatabase db) =>
      db.suppliers.createAlias('task_submissions__supplier_id__suppliers__id');
...
class $$TaskTemplatesTableOrderingComposer
  ...
  ColumnOrderings<bool> get requiresSupplierSelection => $composableBuilder(
    column: $table.requiresSupplierSelection,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$TaskTemplatesTableAnnotationComposer
  ...
  GeneratedColumn<bool> get requiresSupplierSelection => $composableBuilder(
    column: $table.requiresSupplierSelection,
    builder: (column) => column,
  );
